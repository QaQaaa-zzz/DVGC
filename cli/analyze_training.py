...
def main():
    ...
    source_rows=[row for row in rows if any(key.startswith("episode/reset/") for key in row)]; source_last=source_rows[-1] if source_rows else {}
