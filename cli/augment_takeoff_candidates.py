...
def main():
 ...
 meta=dict(src.metadata);meta.update({'artifact_role':'takeoff_proposal_support_v1','certified_tube':False,'safe_claim_allowed':False,'source_anchor_bank':str(Path(a.anchors).resolve()),'source_anchor_bank_sha256':file_sha256(a.anchors),'generation_seed':a.seed,'xml_sha256':file_sha256(cfg.xml_path),'candidate_config_hash':config_hash(cfg),'normalized_dedup_distance':.035})
