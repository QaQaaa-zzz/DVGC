...
RUN="${DESCENT_LOCAL_RUN:-runs/stage_experts/descent_local_seed0_20260716T163504}"
POOL="$RUN/candidate_pool_final.pkl"
RESET_BANK="$RUN/bootstrap_reset_bank.pkl"
INITIAL="$RUN/pi_f_descent_local"
