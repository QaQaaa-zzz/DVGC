...
def test_policy_bundle_provenance(tmp_path):
    ...
    root=save_bundle(tmp_path/"policy",params={"x":1},config=cfg,xml_path="assets/orange_bike_2kg_horizontal.xml",candidate_bank=None,downstream_bank=None,policy_version="test")
